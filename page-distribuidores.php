...
<div class="dst" data-distribuidores-page>
    <section class="dst-hero">
        <nav class="nos-crumb dst-hero__crumb" aria-label="<?php esc_attr_e('Ruta de navegación', 'ese-latam'); ?>" data-reveal="fade">
            ...
            <span aria-current="page"><?php esc_html_e('Distribuidores', 'ese-latam'); ?></span>
        </nav>
