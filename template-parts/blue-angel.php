...
$ese_ba_img = static fn (string $file): string => ESE_LATAM_URI . '/assets/imgs/certificaciones/blue-angel/' . $file;

// Orden del ciclo. Con 5 visibles a la vez y el índice 0 al inicio, el paso
// 2 ("Fabricación de contenedores nuevos") arranca en el centro, como en el Figma.
$ese_ba_pasos = [
    ['label' => __('Recuperación del HDPE reciclado', 'ese-latam'),     'img' => 'prensa.webp'],
    ['label' => __('Control de calidad del material', 'ese-latam'),     'img' => 'inspeccion.webp'],
    ['label' => __('Fabricación de contenedores nuevos', 'ese-latam'),  'img' => 'contenedor.webp'],
    ['label' => __('Distribución de lotes certificados', 'ese-latam'),  'img' => 'lote.webp'],
    ['label' => __('Inspección y sello Blue Angel', 'ese-latam'),       'img' => 'contenedor.webp'],
    ['label' => __('Reciclaje al final de su vida útil', 'ese-latam'),  'img' => 'prensa.webp'],
];
$ese_ba_inicial = 2;
?>
...
<section class="bangel" id="blue-angel" data-bangel data-bangel-autoplay="4000">
    <header class="bangel__header" data-reveal-header>
        ...
        <h2 class="bangel__title">
            <?php echo ese_latam_titulo(__('Estándar', 'ese-latam') .' '. __('|Blue Angel|', 'ese-latam')); ?>
        </h2>
    ...
    <div class="bangel__stage" data-bangel-stage data-reveal="fade" data-reveal-delay="0.2">
        ...
        <svg class="bangel__arc" viewBox="0 0 1000 340" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" data-bangel-arc>
            <defs>
        ...
        <ul class="bangel__items" data-bangel-items>
            <?php foreach ($ese_ba_pasos as $ese_i => $ese_paso) : ?>
                <li class="bangel__item<?php echo $ese_i === $ese_ba_inicial ? ' is-active' : ''; ?>"
                    data-bangel-item data-bangel-name="<?php echo esc_attr($ese_paso['label']); ?>">
                    <button type="button" class="bangel__item-btn" data-bangel-go="<?php echo (int) $ese_i; ?>"
                        ...
                        <img src="<?php echo esc_url($ese_ba_img($ese_paso['img'])); ?>" alt="" loading="lazy" decoding="async" draggable="false">
                    </button>
                </li>
            <?php endforeach; ?>
        </ul>
        ...
        <button type="button" class="bangel__nav bangel__nav--prev" data-bangel-prev aria-label="<?php esc_attr_e('Paso anterior', 'ese-latam'); ?>">
        ...
        <button type="button" class="bangel__nav bangel__nav--next" data-bangel-next aria-label="<?php esc_attr_e('Paso siguiente', 'ese-latam'); ?>">
            <svg width="16" height="13" viewBox="0 0 16 13" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M15.7165 7.15792L9.95748 12.7276C9.77717 12.902 9.53261 13 9.2776 13C9.02259 13 8.77803 12.902 8.59772 12.7276C8.4174 12.5532 8.3161 12.3167 8.3161 12.0701C8.3161 11.8235 8.4174 11.587 8.59772 11.4126L12.7178 7.42945H0.959834C0.70527 7.42945 0.461133 7.33164 0.281129 7.15756C0.101125 6.98347 0 6.74736 0 6.50116C0 6.25496 0.101125 6.01885 0.281129 5.84476C0.461133 5.67067 0.70527 5.57287 0.959834 5.57287H12.7178L8.59932 1.58743C8.419 1.41304 8.3177 1.17652 8.3177 0.929896C8.3177 0.683272 8.419 0.44675 8.59932 0.27236C8.77963 0.0979708 9.02419 0 9.2792 0C9.5342 0 9.77877 0.0979708 9.95908 0.27236L15.7181 5.84208C15.8076 5.92843 15.8786 6.03104 15.9269 6.144C15.9753 6.25696 16.0001 6.37805 16 6.50032C15.9998 6.62259 15.9747 6.74362 15.9261 6.85647C15.8774 6.96933 15.8062 7.07177 15.7165 7.15792Z" fill="currentColor"/></svg>
        </button>
    </div>
</section>
