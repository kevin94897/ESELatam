...
<section id="sectores" class="hero-next bg-white relative z-10">
    ...
    <div class="sectores" data-embla data-embla-contain="false">
        <header class="sectores__header" data-reveal-stagger>
            <div>
                ...
                <div class="embla__container" data-reveal-stagger data-reveal-delay="0.2">
                    <?php foreach ($ese_sectores as $sector) : ?>
                        <article class="embla__slide sector-card">
                            ...
                            <a href="#" class="sector-card__chip" aria-label="<?php echo esc_attr(sprintf(__('Ver más sobre %s', 'ese-latam'), $sector['title'])); ?>">
                                <svg width="16" height="13" viewBox="0 0 16 13" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                    <path d="M15.7165 7.15792L9.95748 12.7276C9.77717 12.902 9.53261 13 9.2776 13C9.02259 13 8.77803 12.902 8.59772 12.7276C8.4174 12.5532 8.3161 12.3167 8.3161 12.0701C8.3161 11.8235 8.4174 11.587 8.59772 11.4126L12.7178 7.42945H0.959834C0.70527 7.42945 0.461133 7.33164 0.281129 7.15756C0.101125 6.98347 0 6.74736 0 6.50116C0 6.25496 0.101125 6.01885 0.281129 5.84476C0.461133 5.67067 0.70527 5.57287 0.959834 5.57287H12.7178L8.59932 1.58743C8.419 1.41304 8.3177 1.17652 8.3177 0.929896C8.3177 0.683272 8.419 0.44675 8.59932 0.27236C8.77963 0.0979708 9.02419 0 9.2792 0C9.5342 0 9.77877 0.0979708 9.95908 0.27236L15.7181 5.84208C15.8076 5.92843 15.8786 6.03104 15.9269 6.144C15.9753 6.25696 16.0001 6.37805 16 6.50032C15.9998 6.62259 15.9747 6.74362 15.9261 6.85647C15.8774 6.96933 15.8062 7.07177 15.7165 7.15792Z" fill="currentColor"/>
                                </svg>
                            </a>
...
<?php // Marquee "Transformamos" (Figma node 3287-283) — texto gigante ligado al scroll ?>
...
<section id="productos" class="productos-wrap bg-white relative z-10">
    <div class="productos">
        <div class="productos__bg" aria-hidden="true">
            <img src="<?php echo esc_url(ESE_LATAM_URI . '/assets/imgs/productos/bg-skyline.png'); ?>"
                 alt="" loading="lazy" decoding="async"
                 data-parallax data-parallax-from="14" data-parallax-to="-14">
        </div>
        <img class="productos__leaves productos__leaves--left"
             src="<?php echo esc_url(ESE_LATAM_URI . '/assets/imgs/productos/leaves.png'); ?>"
             alt="" loading="lazy" decoding="async" aria-hidden="true">
        <img class="productos__leaves productos__leaves--right"
             src="<?php echo esc_url(ESE_LATAM_URI . '/assets/imgs/productos/leaves.png'); ?>"
             alt="" loading="lazy" decoding="async" aria-hidden="true">

        <header class="productos__header" data-reveal="up">
        ...
        <div class="productos__filters" data-reveal="up" role="tablist" aria-label="<?php esc_attr_e('Filtrar productos', 'ese-latam'); ?>">
        ...
        <div class="productos__slider" data-reveal="up">
            ...
            <div class="swiper" data-product-carousel>
...
$ese_distribuidores = [
    [
        'slug' => 'peru', 'name' => __('Perú', 'ese-latam'), 'lat' => -9.19, 'lng' => -75.02,
        'items' => [
    ...
    [
        'slug' => 'chile', 'name' => __('Chile', 'ese-latam'), 'lat' => -35.68, 'lng' => -71.54,
        'items' => [
            ['name' => __('Distribuidor autorizado', 'ese-latam'), 'address' => __('Datos de contacto próximamente', 'ese-latam')],
        ],
    ],
    [
        'slug' => 'colombia', 'name' => __('Colombia', 'ese-latam'), 'lat' => 4.57, 'lng' => -74.30,
        'items' => [
            ['name' => __('Distribuidor autorizado', 'ese-latam'), 'address' => __('Datos de contacto próximamente', 'ese-latam')],
            ['name' => __('Distribuidor autorizado', 'ese-latam'), 'address' => __('Datos de contacto próximamente', 'ese-latam')],
        ],
    ...
    [
        'slug' => 'argentina', 'name' => __('Argentina', 'ese-latam'), 'lat' => -38.42, 'lng' => -63.62,
        'items' => [
            ['name' => __('Distribuidor autorizado', 'ese-latam'), 'address' => __('Datos de contacto próximamente', 'ese-latam')],
        ],
    ],
    [
        'slug' => 'mexico', 'name' => __('México', 'ese-latam'), 'lat' => 23.63, 'lng' => -102.55,
        'items' => [
            ['name' => __('Distribuidor autorizado', 'ese-latam'), 'address' => __('Datos de contacto próximamente', 'ese-latam')],
            ['name' => __('Distribuidor autorizado', 'ese-latam'), 'address' => __('Datos de contacto próximamente', 'ese-latam')],
        ],
    ...
    [
        'slug' => 'ecuador', 'name' => __('Ecuador', 'ese-latam'), 'lat' => -1.83, 'lng' => -78.18,
        'items' => [
            ['name' => __('Distribuidor autorizado', 'ese-latam'), 'address' => __('Datos de contacto próximamente', 'ese-latam')],
            ['name' => __('Distribuidor autorizado', 'ese-latam'), 'address' => __('Datos de contacto próximamente', 'ese-latam')],
        ],
    ...
    [
        'slug' => 'panama', 'name' => __('Panamá', 'ese-latam'), 'lat' => 8.54, 'lng' => -80.78,
        'items' => [
            ['name' => __('Distribuidor autorizado', 'ese-latam'), 'address' => __('Datos de contacto próximamente', 'ese-latam')],
        ],
    ],
    [
        'slug' => 'costa-rica', 'name' => __('Costa Rica', 'ese-latam'), 'lat' => 9.75, 'lng' => -83.75,
        'items' => [
            ['name' => __('Distribuidor autorizado', 'ese-latam'), 'address' => __('Datos de contacto próximamente', 'ese-latam')],
        ],
    ],
    [
        'slug' => 'republica-dominicana', 'name' => __('Rep. Dominicana', 'ese-latam'), 'lat' => 18.74, 'lng' => -70.16,
        'items' => [
            ['name' => __('Distribuidor autorizado', 'ese-latam'), 'address' => __('Datos de contacto próximamente', 'ese-latam')],
        ],
    ],
    [
        'slug' => 'uruguay', 'name' => __('Uruguay', 'ese-latam'), 'lat' => -32.52, 'lng' => -55.77,
        'items' => [
            ['name' => __('Distribuidor autorizado', 'ese-latam'), 'address' => __('Datos de contacto próximamente', 'ese-latam')],
        ],
    ],
    [
        'slug' => 'paraguay', 'name' => __('Paraguay', 'ese-latam'), 'lat' => -23.44, 'lng' => -58.44,
        'items' => [
            ['name' => __('Distribuidor autorizado', 'ese-latam'), 'address' => __('Datos de contacto próximamente', 'ese-latam')],
        ],
    ],
    [
        'slug' => 'honduras', 'name' => __('Honduras', 'ese-latam'), 'lat' => 15.20, 'lng' => -86.24,
        'items' => [
            ['name' => __('Distribuidor autorizado', 'ese-latam'), 'address' => __('Datos de contacto próximamente', 'ese-latam')],
        ],
    ],
    [
        'slug' => 'el-salvador', 'name' => __('El Salvador', 'ese-latam'), 'lat' => 13.79, 'lng' => -88.90,
        'items' => [
            ['name' => __('Distribuidor autorizado', 'ese-latam'), 'address' => __('Datos de contacto próximamente', 'ese-latam')],
        ],
    ],
...
<section id="distribuidores" class="distribuidores relative z-10" data-globe>
    ...
    <div class="distribuidores__globe" data-reveal="fade" data-lenis-prevent aria-hidden="true">
        <div data-globe-canvas
             ...
             data-earth-normal="<?php echo esc_url(ESE_LATAM_URI . '/assets/imgs/distribuidores/earth-normal.jpg'); ?>"></div>
    </div>

    <div class="distribuidores__intro">
        <div class="content-stretch flex items-start" data-reveal="up">
            <p class="type-kicker text-white/90">/ <?php esc_html_e('Distribuidores', 'ese-latam'); ?></p>
        </div>
        <h2 class="distribuidores__title" data-reveal="up" data-reveal-delay="0.1">
        ...
        <p class="distribuidores__desc" data-reveal="up" data-reveal-delay="0.2">
            <?php esc_html_e('Nuestra red de distribuidores autorizados que garantizan soporte técnico y repuestos originales.', 'ese-latam'); ?>
        </p>

        <div class="distribuidores__stat" data-reveal="up" data-reveal-delay="0.3">
            <p class="distribuidores__stat-num"><?php echo count($ese_distribuidores); ?></p>
            <p class="distribuidores__stat-label"><?php esc_html_e('Países conectados', 'ese-latam'); ?></p>
        </div>

        <a href="#contacto" class="distribuidores__link" data-reveal="up" data-reveal-delay="0.4">
    ...
    <div class="distribuidores__list-wrap" data-reveal="left" data-reveal-delay="0.15" data-lenis-prevent>
        <div class="distribuidores__list" data-country-list>
            <?php foreach ($ese_distribuidores as $i => $pais) : ?>
                <button type="button" class="distributor-card<?php echo 0 === $i ? ' is-active' : ''; ?>"
                        data-country
                        data-country-slug="<?php echo esc_attr($pais['slug']); ?>"
                        data-lat="<?php echo esc_attr($pais['lat']); ?>"
                        data-lng="<?php echo esc_attr($pais['lng']); ?>">
                    <span class="distributor-card__bg" aria-hidden="true"></span>
                    <span class="distributor-card__header">
                        <span class="distributor-card__name"><?php echo esc_html($pais['name']); ?></span>
                        <span class="distributor-card__sub distributor-card__sub--collapsed">
                            <?php
                            echo esc_html(sprintf(
                                /* translators: %d: número de distribuidores */
                                _n('Ver %d distribuidor', 'Ver %d distribuidores', count($pais['items']), 'ese-latam'),
                                count($pais['items'])
                            ));
                            ?>
                        </span>
                        <span class="distributor-card__sub distributor-card__sub--expanded">
                            <?php esc_html_e('Conoce nuestros distribuidores oficiales', 'ese-latam'); ?>
                        </span>
                        <span class="distributor-card__toggle" aria-hidden="true">
                            <svg width="12" height="8" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M1 1.5L6 6.5L11 1.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        </span>
                    </span>
                    <span class="distributor-card__body">
                        <span class="distributor-card__body-inner">
                            <?php foreach ($pais['items'] as $item) : ?>
                                <span class="distributor-card__item">
                                    <span class="distributor-card__avatar" aria-hidden="true"><?php echo esc_html(mb_substr($item['name'], 0, 1)); ?></span>
                                    <span class="distributor-card__item-text">
...
<section id="residuos-inteligentes" class="residuos bg-white relative z-10">
    <header class="residuos__header" data-reveal-stagger>
    ...
    <div class="residuos__selector" data-service-selector data-reveal="up">
        <div class="residuos__tabs">
            <?php foreach ($ese_servicios as $i => $servicio) : ?>
                <button type="button" class="residuos__tab<?php echo 0 === $i ? ' is-active' : ''; ?>"
                        data-service-tab
                    ...
                    <span class="residuos__tab-icon" aria-hidden="true">
                        <img src="<?php echo esc_url(ESE_LATAM_URI . '/assets/icons/' . $servicio['icon']); ?>" alt="" loading="lazy">
                    </span>
                    <span class="residuos__tab-text">
                        <span class="residuos__tab-title"><?php echo esc_html($servicio['title']); ?></span>
                        <span class="residuos__tab-sub"><?php esc_html_e('Información clara para tomar decisiones', 'ese-latam'); ?></span>
                    </span>
        ...
        <div class="residuos__panel">
            <div class="residuos__media" data-service-media>
                <img src="<?php echo esc_url(ESE_LATAM_URI . '/assets/imgs/' . $ese_servicios[0]['img']); ?>"
                     alt="" data-service-img loading="lazy" decoding="async">
                <span class="residuos__play" aria-hidden="true">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M8 6.82v10.36c0 .8.87 1.29 1.55.86l8.14-5.18a1 1 0 0 0 0-1.72L9.55 5.96A1 1 0 0 0 8 6.82Z" fill="currentColor"/>
                    </svg>
                </span>
            </div>
            <h3 class="residuos__panel-title" data-service-title><?php echo esc_html($ese_servicios[0]['title']); ?></h3>
...
<section id="certificaciones" class="certificaciones bg-white relative z-10">
    <header class="certificaciones__header" data-reveal-stagger>
        ...
        <a href="#" class="link-arrow">
            <span class="link-arrow__text"><?php esc_html_e('Explora todas nuestras certificaciones', 'ese-latam'); ?></span>
            <span class="link-arrow__icon" aria-hidden="true">
                <svg width="16" height="13" viewBox="0 0 16 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M15.7165 7.15792L9.95748 12.7276C9.77717 12.902 9.53261 13 9.2776 13C9.02259 13 8.77803 12.902 8.59772 12.7276C8.4174 12.5532 8.3161 12.3167 8.3161 12.0701C8.3161 11.8235 8.4174 11.587 8.59772 11.4126L12.7178 7.42945H0.959834C0.70527 7.42945 0.461133 7.33164 0.281129 7.15756C0.101125 6.98347 0 6.74736 0 6.50116C0 6.25496 0.101125 6.01885 0.281129 5.84476C0.461133 5.67067 0.70527 5.57287 0.959834 5.57287H12.7178L8.59932 1.58743C8.419 1.41304 8.3177 1.17652 8.3177 0.929896C8.3177 0.683272 8.419 0.44675 8.59932 0.27236C8.77963 0.0979708 9.02419 0 9.2792 0C9.5342 0 9.77877 0.0979708 9.95908 0.27236L15.7181 5.84208C15.8076 5.92843 15.8786 6.03104 15.9269 6.144C15.9753 6.25696 16.0001 6.37805 16 6.50032C15.9998 6.62259 15.9747 6.74362 15.9261 6.85647C15.8774 6.96933 15.8062 7.07177 15.7165 7.15792Z" fill="currentColor"/>
                </svg>
...
<section id="contacto" class="contacto">
    <div class="contacto__bg" aria-hidden="true">
        <img src="<?php echo esc_url(ESE_LATAM_URI . '/assets/imgs/contacto-bg.jpg'); ?>"
             alt="" loading="lazy" decoding="async">
    </div>

    <div class="contacto__card" data-reveal="fade">
        <p class="type-kicker">/ <?php esc_html_e('Contactemos', 'ese-latam'); ?></p>
